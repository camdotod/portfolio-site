...
const projects = [
...

   {
      ...
      panel4text: "With the feedback from user testing, we made tweaks to the user flows to improve the intuitiveness of the app. We also further developed the graphic design to convey a bright, calm, and trustworthy tone.",
